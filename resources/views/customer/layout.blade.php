...
<head>
    ...
    <style>
        ...
        .bl-nav .btn-reservasi {
            background: var(--sky-dark); color: #fff; border: none;
        ...
        .btn-sky-outline {
            ...
            border: 1.5px solid var(--sky-dark); border-radius: 10px;
        }
...
<nav class="bl-nav">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('customer.cek-status') }}" class="btn btn-sky btn-reservasi">
